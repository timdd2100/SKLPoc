...
+ (void) MR_findAllInContext:(NSManagedObjectContext *)context completion:(void(^)(NSArray *results)) completion;
...
+ (void) MR_findAllWithPredicate:(NSPredicate *)searchTerm inContext:(NSManagedObjectContext *)context completion:(void(^)(NSArray *bookArray)) completion;;
